  ...
  return (
    <Box sx={{ padding: 2 }}>
      ...
      <Box sx={{ marginBottom: 2, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <Typography variant="h4">Recent Employees & Users</Typography>
      ...
      <StaffTable
        users={filteredUsers}
        onView={(id) => setActiveComponent({ name: "AdminViewStaff", props: { id } })}
        onEdit={(id) => setActiveComponent({ name: "AdminEditStaff", props: { id } })}
