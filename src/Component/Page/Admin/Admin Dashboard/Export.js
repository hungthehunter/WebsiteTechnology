              ...
              <TableBody>
                {exportList.map((exportModel) => (
                  <TableRow key={exportModel.id}>
                    ...
                    <TableCell style={{ textAlign: "start",fontSize: '1.3rem' }}>{exportModel.customer.fullname}</TableCell>
                    <TableCell style={{ textAlign: "end",fontSize: '1.3rem' }}>{exportModel.dateExport.split('T')[0]}</TableCell>
                    <TableCell style={{ textAlign: "end",fontSize: '1.3rem' }}>${exportModel.total}</TableCell>
